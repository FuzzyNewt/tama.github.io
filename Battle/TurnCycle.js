class TurnCycle {
  ...
  async turn() {
    ...
    //Stop here if we are replacing this Tama
    ...
    if (targetDead) {
      ...
      if (submission.target.team === "enemy") {
        ...
        const playerActiveTamaId = this.battle.activeCombatants.player;
        ...
        await this.onNewEvent({
          type: "giveXp",
          xp,
          combatant: this.battle.combatants[playerActiveTamaId]
        })
      }
    }
